  ...
  't-modal': {
    ...
    props: {
      fixedClasses: {
        ...
        close: 'flex items-center justify-center rounded absolute right-0 top-0 h-5 w-5 transition duration-100 ease-in-out focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50'
      },
      classes: {
        overlay: 'bg-black',
        wrapper: '',
